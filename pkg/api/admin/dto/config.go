...
type ConfigListDto struct {
	...
	Config_value      string     `form:"config_value" json:"config_value"`           //配置值
	Config_group      string     `form:"config_group" json:"config_group"`           //组
	Config_value_type string     `form:"config_value_type" json:"config_value_type"` //配置值类型 inter html bool  等等
